...
const HeroSection = () => {
  ...
  return (
    <section className="relative bg-cover h-[70vh]  " data-aos="fade-in">
      {/* Content */}
      <div
        className="max-w-8xl flex items-center justify-center pt-10 h-full text-left gap-5"
        style={{
      ...
      >
        <div className="space-y-12 text-black ">
          <h1 className="text-5xl">HRプロダクト事業</h1>
          <p className="text-lg mt-4 mb-8 text-black font-semibold text-nowrap ">
            「候補者の実績や人柄」をAIとデータで可視化し、採用の精度を高め、ミスマッチを防ぐ
          </p>
          <button
            className="bg-black text-white px-20 py-3 rounded flex items-center gap-2 cursor-pointer hover:bg-gray-800 transition-colors"
